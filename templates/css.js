...
app.controller("CSSController", ["$scope", "$http" , "gbserviceCSS", "gbserviceAll", function($scope, $http, gbserviceCSS, gbserviceAll) {
...
gbserviceCSS.getResponse($scope.isSuc,$scope.isFail);
...
$scope.add20 = function() {
  gbserviceCSS.maxResults = gbserviceCSS.maxResults + 10;
   gbserviceCSS.getResponse($scope.isSuc,$scope.isFail);
}
