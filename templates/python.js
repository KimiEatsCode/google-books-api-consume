...
app.controller("PYTHONController", ["$scope", "$http" , "gbservicePY", "gbserviceAll", function($scope, $http, gbservicePY, gbserviceAll) {
...
gbservicePY.getResponse($scope.isSuc,$scope.isFail);
...
$scope.add20 = function() {
  gbservicePY.maxResults = gbservicePY.maxResults + 10;
   gbservicePY.getResponse($scope.isSuc,$scope.isFail);
}
