...
app.controller("PHPController", ["$scope", "$http" , "gbservicePHP", "gbserviceAll", function($scope, $http, gbservicePHP, gbserviceAll) {
...
gbservicePHP.getResponse($scope.isSuc,$scope.isFail);
...
$scope.add20 = function() {
  gbservicePHP.maxResults = gbservicePHP.maxResults + 10;
  gbservicePHP.getResponse($scope.isSuc,$scope.isFail);
}
